...
│
├── data/                    # Datos (Markdown + JSON)
│
├── graph.dot                # Archivo DOT del subgrafo visualizado
├── graph.png                # Renderizado del grafo (22 hubs)
├── qa_output.txt            # Resultados de las consultas QA
│
├── informe_academico.tex    # Memoria LaTeX
├── informe_academico.pdf    # PDF final (12 páginas)
│
├── requirements.txt
├── .gitignore
└── README.md
...
python extract_cerebras.py

# 3. Construcción del grafo
python build_graph.py

# 4. Visualización
python build_graph_dot.py
...
El documento `informe_academico.pdf` (12 páginas) incluye:
